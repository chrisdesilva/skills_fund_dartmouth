import logo from '../images/logo_dartmouth.png'; // add school logo to images folder and import here
...
export const schoolName = 'Dartmouth';

export const schoolURL = 'https://emeritus.engineering.dartmouth.edu/data-science/index.php'; // update with url of school's website

export const skfURL = 'https://dartmouth.skills.fund'; // update with Skills Fund url

export const headline = 'Learn Data Science at Dartmouth'; // update headline as appropriate

export const leadContent = {
	header: 'Your last step on the path toward changing your career',
	paragraph: `${schoolName} designs its programs to provide students with a foundation for a career in data science. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const netlifyFormName = 'dartmouth_contact';

export const GATracking = 'UA-68312423-1';

export const hubspotFormId = '0dca8ae9-b0fb-4deb-8fb7-47223fbed296'; // create Hubspot form, get form id after publishing
